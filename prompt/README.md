...
#### Exercices
1) [Prompt Hacking Online](https://gandalf.lakera.ai/baseline)
2) [Arc AGI-2](https://arcprize.org/arc-agi/2/)
3) (`prompt_engineering_tutorial.ipynb`) --> [Google Colab](https://colab.google/)
